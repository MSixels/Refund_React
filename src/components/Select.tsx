...
export function Select({legend, children, ...rest}: Props) {
  return (
    ...
    <select  className="w-full h-12 rounded-lg border border-gray-300 px-4 text-sm text-gray-100 bg-transparent outline-none focus:border-2 focus:border-green-100" {...rest} value="" >
